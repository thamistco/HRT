        ...
        <div>
          ...
          <div style={{ background: "#F4F7EC", border: `1px solid ${C.line}`, borderRadius: 16, padding: "2px 20px" }}>
            ...
            <NoteSection icon="titrate" title="Loading then maintenance">
              ...
              <IfRow label="Ring"><Chip>Estring® 7.5 µg/24h</Chip> worn continuously, changed 3-monthly (SPC reassessment at 2 years reflects trial duration, not harm; BMS Menopause Practice Standards (June 2026) support continuing as long as needed with annual review)</IfRow>
            </NoteSection>
